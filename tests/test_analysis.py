...
from benford_midi.analysis import analyze_midi_features, classify_benford_compliance, BenfordTests
    ...
    with patch('benford_midi.analysis.mido.MidiFile') as mock_midi:
        with patch('benford_midi.analysis.parse_midi_extended') as mock_parse:
            ...
            mock_parse.return_value = {
                'frequencies': [220, 440, 880, 1760, 3520, 7040, 14080, 28160, 56320, 112640],
