...
from benford_midi.analysis import (
    ...
    compare_directories, print_analysis_summary, analyze_comparison_results,
    create_single_directory_plots, create_comparison_plots
)
...
class TestAnalysisFunctions(unittest.TestCase):
    ...
    def test_analyze_comparison_results(self):
        ...
        # Create mock results
        results_dir1 = [['test1.mid', 0.8, 0.7, 0.6, 0.5, 0.4, 0.75, 0.65, 0.01, 0.08, 1.5, 0.75, 'Strong', 'Evidence', 'props']]
        results_dir2 = [['test2.mid', 0.3, 0.2, 0.1, 0.15, 0.25, 0.2, 0.3, 0.03, 0.15, 3.0, 0.25, 'Weak', 'Evidence', 'props']]
        
        combined_df = analyze_comparison_results(results_dir1, results_dir2, "dir1", "dir2")
